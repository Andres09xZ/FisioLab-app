...
### Planes
14. [GET /planes/:id](#get-planesid) - Obtener plan (con contador total de sesiones) ⭐ MEJORADO
15. [GET /planes/:id/sesiones](#get-planesidsesiones) - Sesiones del plan
16. [POST /planes/:id/generar-sesiones](#post-planesidgenerar-sesiones) - Generar sesiones automáticas
17. [POST /planes/:id/generar-sesiones-pendientes](#post-planesidgenerar-sesiones-pendientes) - Generar sesiones pendientes

### Pacientes
18. [GET /pacientes/:id/sesiones-pendientes](#get-pacientesidsesiones-pendientes) - Sesiones pendientes ⭐ NUEVO

### Agenda
19. [GET /agenda/disponibilidad](#get-agendadisponibilidad) - Verificar disponibilidad
